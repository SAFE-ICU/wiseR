...
If the user does not wish to run bootstraps, they may choose the "Direct Learning" tab for learning the structure without bootstraps, however this may give less robust results structure learning.
