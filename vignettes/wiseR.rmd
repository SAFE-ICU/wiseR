...
An intuitive left-to-right ordering of tabs guides the user into the analysis. The main page of the **_wiseR_** engine has 5 tabs named 'App Settings','Data','Association Network','Bayesian Network' and 'Publish your dashboard', each tab covering a specific functionality (Figure S2). Each of these is described next.

<img src="1.png" height="400px" width="750px" />

#### Figure S2. Functional tabs on the main page of the **_wiser_** engine.
...
#### Figure S3. Setting the number of clusters to be used for task parallelization in Bootstrap Structure Learning.
