...
#### Figure 1. Flowchart showing logic of wiseR
...
An intuitive left-to-right ordering of tabs guides the user into the analysis. The main page has 5 tabs named 'App Settings','Data','Association Network','Bayesian Network' and 'Publish your dashboard', each tab covering a specific functionality (Figure 1). Each of these is described next.

<img src="1.png" height="400px" width="750px" />

```{r, fig.cap = paste("Testing.")}
```
